...
namespace Script {
    ...
    public class UI : MonoBehaviour {
        ...
        private void Awake() {
            ...
            // }
            GoldReach100Achievement I1 = new GoldReach100Achievement(gold);
            GoldReach1000Achievement I2 = new GoldReach1000Achievement(gold);
            I1.onAchieve += onAchieveChange;
            I2.onAchieve += onAchieveChange;
